...
| `AutoAnswerSettingsStore.kt` | Interruptor mestre do atendimento automático (por aparelho) e o tempo de contagem antes de atender sozinho (10 a 30 s) — atrás de `admin/AdminAccess.kt` |
...
| `admin/ui/AdminActivity.kt` | Tela de "Recursos avançados": digitar a senha (global ou local), cadastrar a senha local deste aparelho, e o painel com o interruptor de atendimento automático, o tempo de contagem antes dele atender e a duração máxima da chamada |
